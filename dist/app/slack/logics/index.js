...
// const ky = require('ky');
var SLACK_CLIENT_ID = '353190391027.786804600948';
function getAuthorizeUrl() {
    var scope = ['incoming-webhook'];
    var redirect_uri = 'http://localhost:8080/slack/authorize';
    // const now = Date.now();
    // const state = {
    //   now,
    //   i: userId,
...
function exchangeAuthorizationCode(_a) {
    var code = _a.code, state = _a.state;
    return __awaiter(this, void 0, void 0, function () {
        var SLACK_CLIENT_SECRET, body;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    SLACK_CLIENT_SECRET = '6904db9966b9debf2af772efcaec118a';
                    body = { json: {
                            client_id: SLACK_CLIENT_ID,
                            client_secret: SLACK_CLIENT_SECRET,
                            code: code,
                        } };
                    return [4 /*yield*/, ky_1.default.post('https://slack.com/api/oauth.access', body).json()];
